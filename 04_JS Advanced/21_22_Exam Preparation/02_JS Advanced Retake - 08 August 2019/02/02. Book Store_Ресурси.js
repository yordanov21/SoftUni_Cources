...
console.log(myClass.stockBooks(['Book Title-Ivanov', 'Book Title2-Ivanov2']));


module.exports = BookStore; // This piece of code exports the Class, so it could be accessed in other files.