namespace SystemTypeMethods
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            FieldInfo privateField = personType.GetField("age", BindingFlags.NonPublic | BindingFlags.Instance); // now found age when use binding flags
            ...
            // Constructors Info  //shearch by paramaters, because the name is only one(the name of the class)
