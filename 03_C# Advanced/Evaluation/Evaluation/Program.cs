...
namespace Evaluation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter your presences:(number between 1-20)");
            int precences = int.Parse(Console.ReadLine());
            Console.WriteLine();
            double precentOfBonus =(double)(precences / 20.0)*5.0;

            Console.WriteLine("Enter your homeworks(num betwen 1-8)");
            int homeWork = int.Parse(Console.ReadLine());
            Console.WriteLine();
            double homeWorkBonus = homeWork / 8.0*5;
